        ...
        <div className="flex flex-col bg-white p-4 gap-4 md:p-16 md:gap-16">
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-4 md:flex md:justify-evenly border-4 rounded-xl py-10">
            ...
            <div className="flex flex-col items-center">
              <div className=" border-4 border-[#ffe080] rounded-full p-2 w-min">
                <HiChatBubbleLeftRight className="text-4xl md:text-9xl text-[#ffe080]" />
              </div>
          ...
          <p className="text-slate-500 text-center p-4">
            ...
            <Link href={"activities"} className="bg-orange-400 h-min px-2 hover:bg-orange-500 text-white duration-150 rounded-xl mx-1">
              Activities
            </Link>section
          </p>
          {/* 
