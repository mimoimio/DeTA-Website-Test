...
const Mission = ({ image, title, description, point1, point2, point3 }) => {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
          ...
          >
            <div className="glass-card p-8 lg:p-10">
              <span className="text-orange-500 font-semibold text-sm uppercase tracking-wider">Our Purpose</span>
